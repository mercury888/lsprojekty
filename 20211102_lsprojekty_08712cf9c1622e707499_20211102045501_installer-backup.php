...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211102_lsprojekty_08712cf9c1622e707499_20211102045501_archive.zip';
	const ARCHIVE_SIZE		 = '47535798';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '08712cf-02045501';
    const SECONDARY_PACKAGE_HASH = 'db08243-02045501';
	const VERSION			 = '1.4.3';
